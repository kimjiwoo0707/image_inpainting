...
image_paths = sorted(glob('/home/work/jiu/open/train_gt/TRAIN_*.png'))
...
train_df.to_csv('/home/work/jiu/preproc/train_preproc.csv', index=False)

test_image_paths = sorted(glob('/home/work/jiu/open/test_input/TEST_*.png'))

test_df = pd.DataFrame(columns=['image'])

test_df['image'] = [os.path.basename(image_path) for image_path in test_image_paths]

test_df.to_csv('/home/work/jiu/preproc/test_preproc.csv', index=False)
